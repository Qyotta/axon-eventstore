...
public final class EsEventStoreUtils {
   ...
   public static DomainEventMessage domainEventMessageOf(final EventResponse eventResponse) {
      try {
         ...
         return new GenericDomainEventMessage(eventResponse.getId(), new DateTime(eventResponse.getUpdated(), DateTimeZone.UTC), data.getAggregateIdentifier(), eventResponse.getContent()
