...
// COPY OF https://raw.githubusercontent.com/google/gson/master/extras/src/main/java/com/google/gson/typeadapters/RuntimeTypeAdapterFactory.java

/**
 * Adapts values whose runtime type may differ from their declaration type. This is necessary when a field's type is not the same type that GSON should create when deserializing that field. For
 ...
 *
 * <h3>Registering Types</h3> Create a {@code RuntimeTypeAdapterFactory} by passing the base type and type field name to the {@link #of} factory method. If you don't supply an explicit type field
 ...
 * </pre>
 * 
 * Next register all of your subtypes. Every subtype must be explicitly registered. This protects your application from injection attacks. If you don't supply an explicit type label, the type's simple
 * name will be used.
 * 
 * <pre>
 *    {@code
   ...
   public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
      ...
      return new TypeAdapter<R>() {
         ...
         public R read(JsonReader in) throws IOException {
            ...
            final JsonElement labelJsonElement = jsonElement.getAsJsonObject()
         ...
         public void write(JsonWriter out, R value) throws IOException {
            ...
            final JsonObject jsonObject = delegate.toJsonTree(value)
                  .getAsJsonObject();
