...
public class TestConfiguration {
   ...
   @Bean
   @Autowired
   public EventStore eventStore(final UpcasterChain upcasterChain) {
   ...
   @Bean
   @Autowired
   public UpcasterChain upcasterChain() {
      @SuppressWarnings("rawtypes")
      final List<Upcaster> upcasters = Arrays.asList(); // add upcasters here
      return new SimpleUpcasterChain(new JavaSerializer(), upcasters);
   }
